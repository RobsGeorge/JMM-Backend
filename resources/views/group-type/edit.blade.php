                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">تعديل نوع مجموعة</h6>
                        </div>
                    </div>

                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="post" action="{{ route('group-type.update', $groupType->GroupTypeID) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-header py-3">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                <label>ID = {{$groupType->GroupTypeID}}</label>
                                                <input type="text" class="form-control form-control-user" name="group_type_name" id="group_type_name" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                                    placeholder="ادخل اسم نوع المجموعة" onfocusout="myFunction()" value="{{$groupType->GroupTypeName}}">
                                                    <br>
