        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="post" action="{{ route('university.update', $university->UniversityID) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-header py-3">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                <label>ID = {{ $university->UniversityID}}</label>
                                                <input type="text" class="form-control form-control-user" name="university_name" id="university_name" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                                    placeholder="ادخل اسم الجامعة" onfocusout="myFunction()" value="{{$university->UniversityName}}">
                                                    <br>
