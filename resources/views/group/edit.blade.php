                                    ...
                                    <div class="card-header">        
                                        <div class="form-group" dir="rtl" style="text-align: right">
                                            ...
                                            <select class="form-control col-sm-4 select2" style="margin-right: 20px;" name="group_type_id" id="group_type_id">
                                                <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="{{$groupSelected->GroupTypeID}}" selected>{{$groupSelected->GroupTypeName}}</option>
                                        ...
                                        <div class="form-group" dir="rtl" style="text-align: right">
                                            ...
                                            <select class="form-control col-sm-4 select2" style="margin-right: 20px;" name="included_under_group_id" id="included_under_group_id">
                                                <option style="font-family: 'Cairo', sans-serif; color: black; font-size: large" value="{{$groupSelected->IncludedUnderGroupID}}" selected>{{$groupSelected->GroupInfo}}</option>
