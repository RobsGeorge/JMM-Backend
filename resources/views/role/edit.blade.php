                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">تعديل دور/مهمة</h6>
                        </div>
                    </div>

                    <div class="card shadow mb-4">
                        <form class="user" id="regForm" method="post" action="{{ route('role.update', $role->RoleID) }}">
                            @method('PATCH')
                            @csrf
                            <div class="card-header py-3">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                                <label>ID = {{$role->RoleID}}</label>
                                                <input type="text" class="form-control form-control-user" name="role_name" id="role_name" style="font-family: 'Cairo', sans-serif; font-size: medium"
                                                    placeholder="ادخل اسم الدور" onfocusout="myFunction()" value="{{$role->RoleName}}">
                                                    <br>
